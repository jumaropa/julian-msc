...
V = TestFESpace(model_Ω, reffeᵤ, labels=labels_Ω, conformity=:Hdiv, dirichlet_tags=["inlet", "top", "left_p", "bottom", "left_corner"])
Q = TestFESpace(model_Ω, reffeₚ, conformity=:L2, constraint=:zeromean)
...
writevtk(Ωₕ,"channel-flow-static-rav2-results",order=2,cellfields=["uh"=>uh,"ph"=>ph])
end
